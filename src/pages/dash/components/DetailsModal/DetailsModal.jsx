    ...
    >
      ...
      <Modal.Body>
        ...
        <div className="_detail_row">
          ...
          <p className="_detail_value">{data.telephone}</p>
        </div>
        <div className="_detail_row">
          <p className="_detail_label">Date of birth:</p>
          <p className="_detail_value">{data.dateOfBirth}</p>
        </div>
        {data.countryOfBirth && (
          <div className="_detail_row">
            <p className="_detail_label">Country of birth:</p>
            <p className="_detail_value">{data.countryOfBirth}</p>
          </div>
        )}
        {data.cityOfBirth && (
          <div className="_detail_row">
            <p className="_detail_label">City of birth:</p>
            <p className="_detail_value">{data.cityOfBirth}</p>
          </div>
        )}
        ...
        {data.zip && (
          <div className="_detail_row">
            ...
            <p className="_detail_value">{data.zip}</p>
          </div>
        )}
        <div className="_pdf_boxes">
          <div className="_pdf_boxe">
            ...
            <div className="_buttons">
              <div
                className="_btn"
                onClick={() => {
                  handleClick(data.acedemicCareer);
                }}
              >
                <svg
                  viewBox="0 0 24 24"
          ...
          <div className="_pdf_boxe">
            ...
            <div className="_buttons">
              <div
                className="_btn"
                onClick={() => {
                  handleClick(data.DegreeObtained);
                }}
              >
                <svg
                  viewBox="0 0 24 24"
          ...
          <div className="_pdf_boxe">
            <div className="_label">
              <p>Copy of a valid identification document</p>
            </div>
            <div className="_buttons">
              <div
                className="_btn"
                onClick={() => {
                  handleClick(data.IdentificationDocument);
                }}
              >
                <svg
                  viewBox="0 0 24 24"
          ...
          {data.LinguisticCertification && (
            <div className="_pdf_boxe">
              <div className="_label">
                <p>Linguistic certification</p>
              </div>
              <div className="_buttons">
                <div
                  className="_btn"
                  onClick={() => {
                    handleClick(data.LinguisticCertification);
                  }}
                >
                  <svg
                    viewBox="0 0 24 24"
