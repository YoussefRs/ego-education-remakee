              ...
              <div className="col-xl-6 col-lg-6" data-aos={"slide-right"}>
                <div className="it-about-right-box">
                  ...
                  <p>
                    ...
                    , the advisory firm Gartner shows that global talent
                    shortage is now the top emerging risk facing organizations,
                    with 63% of respondents indicating that a talent shortage
                    was a key concern for their organization. Furthermore, the
                    firm HDI values the effects of the issue in $8 trillion in
                    unrealised revenue by 2030.
                    <br />
                    <br />
                    <strong style={{ color: "#046635" }}>eGO Education</strong>
                    ’s goal is to become an{" "}
                    <strong style={{ color: "#046635" }}>
                    ...
                    training offer, rarely present in current online
                    universities, will be implemented through knowledge of local
                    work dynamics, the needs of competitiveness and
                    internationalisation of the global market and through
                    partnerships with the structures present therein.
                  </p>
                </div>
              </div>
