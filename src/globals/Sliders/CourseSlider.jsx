            ...
            {console.log(course)}
              <div className="container">
                <div className="slide-content w-100">
                  <div className="course_icon_ d-flex align-items-center gap-2 mb-4 flex-wrap">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" class="bi bi-mortarboard" viewBox="0 0 16 16">
